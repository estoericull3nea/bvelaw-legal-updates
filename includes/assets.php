...
/**
 * Enqueue admin assets for legal update add/edit screen
 *
 * @param string $hook_suffix Current admin page hook suffix.
 */
function bve_lu_enqueue_admin_assets($hook_suffix)
{
    if ($hook_suffix !== 'legal-updates_page_bve-legal-updates-add') {
        return;
    }

    // Keep media library available inside wp_editor().
    wp_enqueue_media();
}
add_action('admin_enqueue_scripts', 'bve_lu_enqueue_admin_assets');
